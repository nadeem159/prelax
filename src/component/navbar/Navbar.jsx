         ...
         <Menu.Item>
           <NavLink to="/"> <img src='images/left-logo.png' alt='logo' style={{height:"20px"}} /></NavLink> 
            ...
            <Menu.ItemGroup title="Item 2" className='bg bg-dark text-white'>
              <Menu.Item><NavLink to="reduxget"><span>Redux</span></NavLink></Menu.Item>
              <Menu.Item ><NavLink to="ssladd" style={{color: 'white', textDecoration: 'none'}}>SSL</NavLink></Menu.Item>
            </Menu.ItemGroup>
             </SubMenu>
     </Menu>
